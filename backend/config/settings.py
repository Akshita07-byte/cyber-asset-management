...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-=+tr0fg^*45n$d8hx9qns@lpwp4(916bi10b!&sy*b%3=8y)8_')
...
# Default to PostgreSQL local if credentials supplied in env, else sqlite
